...
export default function Insights({ records, street }: { records: any[]; street: string }) {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6">
      <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-md border border-blue-200">
      ...
      <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-md border border-purple-200">
        <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
        ...
        <div className="text-xs sm:text-sm text-slate-700">
          ...
          {peaks.length > 0 && (
            <>
              <p className="text-xl sm:text-2xl font-bold text-purple-600 mb-1 sm:mb-2">{peaks.length} detectado{peaks.length > 1 ? 's' : ''}</p>
              <div className="space-y-1">
                {peaks.slice(0, 3).map((p) => (
                  <div key={p} className="text-xs bg-white rounded px-2 py-1 text-purple-700 font-medium">
      ...
      <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-md border border-green-200">
        <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
      ...
      <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-md border border-orange-200">
        <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
        ...
        <p className="text-2xl sm:text-3xl font-bold text-orange-600 mb-1">{totalTransactions.toLocaleString('pt-BR')}</p>
